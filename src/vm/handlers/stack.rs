...
pub(super) fn emit_call8(seq: &mut Vec<(Instruction, Option<Cl>)>) {
    ...
    seq.push((
        Instruction::with2(
            Code::Lea_r64_m,
            Register::RDX,
            MemoryOperand::with_base_displ(Register::R9, 1),
        )
        .unwrap(),
        None,
    ));
...
pub(super) fn emit_native_call(seq: &mut Vec<(Instruction, Option<Cl>)>) {
    seq.push((
        ...
        .unwrap(),
        Some(Cl::Handler(OP_NATIVE_CALL)),
    ));
    seq.push((
    ...
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R11, vreg(Register::RAX)).unwrap(),
        None,
    ));
    seq.push((
    ...
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R12, Register::R8).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R13, Register::R9).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R14, Register::R10).unwrap(),
        None,
    ));
    ...
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RCX, m(Register::R12, 8)).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RDX, m(Register::R12, 16)).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R8, m(Register::R12, 64)).unwrap(),
        None,
    ));
    seq.push((
    ...
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R15, Register::RSP).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::And_rm64_imm32, Register::RSP, -16i32).unwrap(),
        None,
    ));
    ...
    seq.push((
        Instruction::with2(Code::Sub_rm64_imm32, Register::RSP, 0x60).unwrap(),
        None,
    ));
    ...
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RAX, m(Register::R12, 0x20)).unwrap(),
        None,
    ));
    ...
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RBX, m(Register::R12, 24)).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RBP, m(Register::R12, 40)).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RSI, m(Register::R12, 48)).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RDI, m(Register::R12, 56)).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R8, m(Register::R12, 64)).unwrap(),
    ...
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::RSP, Register::R15).unwrap(),
        None,
    ));
    ...
    seq.push((
        Instruction::with2(Code::Mov_rm64_r64, m(Register::R12, 0), Register::RAX).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_rm64_r64, m(Register::R12, 24), Register::RBX).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_rm64_r64, m(Register::R12, 40), Register::RBP).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_rm64_r64, m(Register::R12, 48), Register::RSI).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_rm64_r64, m(Register::R12, 56), Register::RDI).unwrap(),
        None,
    ));
    // restore VM infra
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R8, Register::R12).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R9, Register::R13).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_r64_rm64, Register::R10, Register::R14).unwrap(),
        None,
    ));
    seq.push((
...
pub(super) fn emit_ret_imm16(seq: &mut Vec<(Instruction, Option<Cl>)>) {
    ...
    seq.push((
        Instruction::with2(Code::Add_rm64_r64, Register::R11, Register::RDI).unwrap(),
        None,
    ));
    seq.push((
        Instruction::with2(Code::Mov_rm64_r64, m(Register::R8, 0x20), Register::R11).unwrap(),
