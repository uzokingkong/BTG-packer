...
pub(super) use alu_arith::{
    ...
    emit_cmp_r_imm32, emit_inc_dec, emit_neg, emit_not, emit_or_imm, emit_or_rr, emit_rol_r_imm8,
    emit_ror_r_imm8, emit_test,
};
pub(super) use alu_bmi::{emit_andn, emit_blsi, emit_blsmsk, emit_blsr, emit_lzcnt, emit_popcnt};
pub(super) use alu_shift::{
    emit_shift_cl_32, emit_shift_cl_64, emit_shift_imm8_32, emit_shift_imm8_64, emit_shld_shrd,
};
