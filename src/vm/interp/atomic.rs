        ...
        OP_XADD_MEM8_A | OP_XADD_MEM16_A | OP_XADD_MEM32_A | OP_XADD_MEM64_A => {
            ...
            match w {
                1 => {
                    ...
                    set_vreg64(state, src, (sv & !0xFF) | (a as u64))?;
                ...
                2 => {
                    ...
                    let b = sv as u16;
                    mem_put(mem, addr, &a.wrapping_add(b).to_le_bytes())?;
                    set_vreg64(state, src, (sv & !0xFFFF) | (a as u64))?;
                ...
                4 => {
                    ...
                    let b = sv as u32;
                    mem_put(mem, addr, &a.wrapping_add(b).to_le_bytes())?;
                    set_vreg64(state, src, a as u64)?; // xadd eax zero-extends
