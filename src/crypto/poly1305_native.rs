...
pub fn emit_poly1305_verify_blob(_state_va: u64) -> Vec<u8> {
    ...
    push(&mut s, Instruction::with2(Code::Mov_r64_rm64, Register::R14, Register::R8).unwrap());
    push(&mut s, Instruction::with2(Code::Mov_r64_rm64, Register::R15, Register::R9).unwrap());
    // frame (must be allocated BEFORE any rsp-relative store — the LEN_OFF store
    // below is inside the frame)
    push(&mut s, Instruction::with2(Code::Sub_rm64_imm32, Register::RSP, FRAME).unwrap());
    // save original len (r13 is consumed by the CT loop)
    push(&mut s, Instruction::with2(Code::Mov_rm64_r64, w(LEN_OFF), Register::RDX).unwrap());
    ...
    // ---- epilogue ----
    push(&mut s, Instruction::with2(Code::Add_rm64_imm32, Register::RSP, FRAME).unwrap());
...
fn emit_init(s: &mut Seq) {
    push(s, Instruction::with2(Code::Xor_r32_rm32, Register::EAX, Register::EAX).unwrap());
    for i in 0..5 {
        push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + (i as i32) * 4), Register::EAX).unwrap());
    }
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w_disp(Register::R14, 0)).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, 0x3ff_ffffu32).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(R_OFF + 0), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w_disp(Register::R14, 3)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 2).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, 0x3ff_ff03u32).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(R_OFF + 4), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w_disp(Register::R14, 6)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 4).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, 0x3ff_c0ffu32).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(R_OFF + 8), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w_disp(Register::R14, 9)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 6).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, 0x3f0_3fffu32).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(R_OFF + 12), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w_disp(Register::R14, 12)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 8).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, 0xf_ffffu32).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(R_OFF + 16), Register::EAX).unwrap());
    for i in 0..4 {
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w_disp(Register::R14, 16 + (i as i32) * 4)).unwrap());
        push(s, Instruction::with2(Code::Mov_rm32_r32, w(PAD_OFF + (i as i32) * 4), Register::EAX).unwrap());
    }
}
...
fn emit_absorb_aad(s: &mut Seq) {
    for i in 0..4 {
        ...
        push(s, Instruction::with2(Code::Mov_rm32_imm32, w(BLK_OFF + (i as i32) * 4), word).unwrap());
    }
    emit_absorb(s, false);
}
...
fn emit_absorb(s: &mut Seq, partial: bool) {
    ...
    // h += m
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(BLK_OFF + 0)).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + 0), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(BLK_OFF + 3)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 2).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + 4), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(BLK_OFF + 6)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 4).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + 8), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(BLK_OFF + 9)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 6).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + 12), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(BLK_OFF + 12)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 8).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    if hibit != 0 {
        push(s, Instruction::with2(Code::Or_rm32_imm32, Register::EAX, hibit).unwrap());
    }
    push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + 16), Register::EAX).unwrap());
...
fn emit_mul_reduce(s: &mut Seq) {
    let d_terms: [[(i32, i32, bool); 5]; 5] = [
        [(0, 0, false), (1, 4, true), (2, 3, true), (3, 2, true), (4, 1, true)],
        [(0, 1, false), (1, 0, false), (2, 4, true), (3, 3, true), (4, 2, true)],
        [(0, 2, false), (1, 1, false), (2, 0, false), (3, 4, true), (4, 3, true)],
        [(0, 3, false), (1, 2, false), (2, 1, false), (3, 0, false), (4, 4, true)],
        [(0, 4, false), (1, 3, false), (2, 2, false), (3, 1, false), (4, 0, false)],
    ];
    for (di, terms) in d_terms.iter().enumerate() {
        push(s, Instruction::with2(Code::Xor_r32_rm32, Register::R8D, Register::R8D).unwrap());
        for &(h_idx, r_idx, is_s) in terms {
            push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w(H_OFF + h_idx * 4)).unwrap());
            push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, w(R_OFF + r_idx * 4)).unwrap());
            if is_s {
                push(s, Instruction::with3(Code::Imul_r32_rm32_imm8, Register::EDX, Register::EDX, 5).unwrap());
            }
            push(s, Instruction::with2(Code::Imul_r64_rm64, Register::RCX, Register::RDX).unwrap());
            push(s, Instruction::with2(Code::Add_rm64_r64, Register::R8, Register::RCX).unwrap());
        }
        push(s, Instruction::with2(Code::Mov_rm64_r64, w(D_OFF + (di as i32) * 8), Register::R8).unwrap());
    }

    // ---- carry-reduce ----
    // c = d0>>26; h0 = d0 & M; d1 += c
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RAX, w(D_OFF + 0)).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RDX, Register::RAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm64_imm8, Register::RDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm64_imm32, Register::RAX, LIMB_MASK as u64).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + 0), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Add_rm64_r64, w(D_OFF + 8), Register::RDX).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RAX, w(D_OFF + 8)).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RDX, Register::RAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm64_imm8, Register::RDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm64_imm32, Register::RAX, LIMB_MASK as u64).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + 4), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Add_rm64_r64, w(D_OFF + 16), Register::RDX).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RAX, w(D_OFF + 16)).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RDX, Register::RAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm64_imm8, Register::RDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm64_imm32, Register::RAX, LIMB_MASK as u64).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + 8), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Add_rm64_r64, w(D_OFF + 24), Register::RDX).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RAX, w(D_OFF + 24)).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RDX, Register::RAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm64_imm8, Register::RDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm64_imm32, Register::RAX, LIMB_MASK as u64).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + 12), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Add_rm64_r64, w(D_OFF + 32), Register::RDX).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RAX, w(D_OFF + 32)).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RDX, Register::RAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm64_imm8, Register::RDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm64_imm32, Register::RAX, LIMB_MASK as u64).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + 16), Register::EAX).unwrap());
    push(s, Instruction::with3(Code::Imul_r64_rm64_imm8, Register::RDX, Register::RDX, 5).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + 0), Register::EDX).unwrap());
    // c = h0>>26; h0 &= M; h1 += c
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 0)).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + 0), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + 4), Register::EDX).unwrap());
}
...
fn emit_absorb_ct_loop(s: &mut Seq) {
    lab(s, "ct_loop");
    push(s, Instruction::with2(Code::Cmp_rm64_imm32, Register::R13, 16).unwrap());
    push(s, Instruction::with_branch(Code::Jb_rel32_64, 0).unwrap());
    s.last_mut().unwrap().1 = Some("ct_partial_check".to_string());
    for i in 0..4 {
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w_disp(Register::R12, (i as i32) * 4)).unwrap());
        push(s, Instruction::with2(Code::Mov_rm32_r32, w(BLK_OFF + (i as i32) * 4), Register::EAX).unwrap());
    }
    emit_absorb(s, false);
    push(s, Instruction::with2(Code::Add_rm64_imm32, Register::R12, 16).unwrap());
    push(s, Instruction::with2(Code::Sub_rm64_imm32, Register::R13, 16).unwrap());
    ...
    push(s, Instruction::with2(Code::Test_rm64_r64, Register::R13, Register::R13).unwrap());
    push(s, Instruction::with_branch(Code::Je_rel32_64, 0).unwrap());
    s.last_mut().unwrap().1 = Some("ct_done".to_string());
    push(s, Instruction::with2(Code::Mov_rm64_imm32, w(BLK_OFF + 0), 0i32).unwrap());
    push(s, Instruction::with2(Code::Mov_rm64_imm32, w(BLK_OFF + 8), 0i32).unwrap());
    ...
    push(s, Instruction::with2(Code::Lea_r64_m, Register::RCX, w(BLK_OFF)).unwrap());
    push(s, Instruction::with2(Code::Xor_r32_rm32, Register::R8D, Register::R8D).unwrap());
    lab(s, "ct_partial_copy");
    push(s, Instruction::with2(Code::Cmp_rm64_r64, Register::R8, Register::R13).unwrap());
    push(s, Instruction::with_branch(Code::Jae_rel32_64, 0).unwrap());
    s.last_mut().unwrap().1 = Some("ct_partial_byte_done".to_string());
    push(s, Instruction::with2(Code::Movzx_r32_rm8, Register::EAX, w_disp_idx(Register::R12, Register::R8)).unwrap());
    push(s, Instruction::with2(Code::Mov_rm8_r8, w_disp_idx(Register::RCX, Register::R8), Register::AL).unwrap());
...
fn emit_absorb_lengths(s: &mut Seq) {
    push(s, Instruction::with2(Code::Mov_rm64_imm32, w(BLK_OFF + 0), POLY1305_AEAD_AAD.len() as i32).unwrap());
    push(s, Instruction::with2(Code::Mov_r64_rm64, Register::RAX, w(LEN_OFF)).unwrap());
    push(s, Instruction::with2(Code::Mov_rm64_r64, w(BLK_OFF + 8), Register::RAX).unwrap());
    emit_absorb(s, false);
}
...
fn emit_finish_compare(s: &mut Seq) {
    let carry_up = |s: &mut Seq, src: i32, dst: i32| {
        ...
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + src * 4)).unwrap());
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, Register::EAX).unwrap());
        push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 26).unwrap());
        push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
        push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + src * 4), Register::EAX).unwrap());
        push(s, Instruction::with2(Code::Add_rm32_r32, w(H_OFF + dst * 4), Register::EDX).unwrap());
    };
    carry_up(s, 1, 2);
    carry_up(s, 2, 3);
    carry_up(s, 3, 4);
    // c = h4>>26; h4 &= M; h0 += c*5
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 16)).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + 16), Register::EAX).unwrap());
    ...
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 0)).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_imm32, Register::EAX, 5).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 0), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w(H_OFF + 4)).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, Register::ECX, Register::EDX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, Register::ECX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::ECX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 4), Register::ECX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 8)).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, Register::EAX, Register::EDX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::EAX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 8), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w(H_OFF + 12)).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, Register::ECX, Register::EDX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, Register::ECX).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 26).unwrap());
    push(s, Instruction::with2(Code::And_rm32_imm32, Register::ECX, LIMB_MASK).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 12), Register::ECX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 16)).unwrap());
    push(s, Instruction::with2(Code::Add_rm32_r32, Register::EAX, Register::EDX).unwrap());
    push(s, Instruction::with2(Code::Sub_rm32_imm32, Register::EAX, 1 << 26).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 16), Register::EAX).unwrap());

    // select: mask = (g4 >> 31) - 1 (all-ones if g4 negative)
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EDX, w(D_OFF + 16)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EDX, 31).unwrap());
    push(s, Instruction::with2(Code::Sub_rm32_imm32, Register::EDX, 1).unwrap());
    for i in 0..5 {
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(D_OFF + (i as i32) * 4)).unwrap());
        push(s, Instruction::with2(Code::And_rm32_r32, Register::EAX, Register::EDX).unwrap());
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, Register::EDX).unwrap());
        push(s, Instruction::with1(Code::Not_rm32, Register::ECX).unwrap());
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ESI, w(H_OFF + (i as i32) * 4)).unwrap());
        push(s, Instruction::with2(Code::And_rm32_r32, Register::ESI, Register::ECX).unwrap());
        push(s, Instruction::with2(Code::Or_rm32_r32, Register::EAX, Register::ESI).unwrap());
        push(s, Instruction::with2(Code::Mov_rm32_r32, w(H_OFF + (i as i32) * 4), Register::EAX).unwrap());
    }

    // combine h -> t0..t3 (128-bit)
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 4)).unwrap());
    push(s, Instruction::with2(Code::Shl_rm32_imm8, Register::EAX, 26).unwrap());
    push(s, Instruction::with2(Code::Or_r32_rm32, Register::EAX, w(H_OFF + 0)).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 0), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 4)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 6).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w(H_OFF + 8)).unwrap());
    push(s, Instruction::with2(Code::Shl_rm32_imm8, Register::ECX, 20).unwrap());
    push(s, Instruction::with2(Code::Or_rm32_r32, Register::EAX, Register::ECX).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 4), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 8)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 12).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w(H_OFF + 12)).unwrap());
    push(s, Instruction::with2(Code::Shl_rm32_imm8, Register::ECX, 14).unwrap());
    push(s, Instruction::with2(Code::Or_rm32_r32, Register::EAX, Register::ECX).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 8), Register::EAX).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(H_OFF + 12)).unwrap());
    push(s, Instruction::with2(Code::Shr_rm32_imm8, Register::EAX, 18).unwrap());
    push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w(H_OFF + 16)).unwrap());
    push(s, Instruction::with2(Code::Shl_rm32_imm8, Register::ECX, 8).unwrap());
    push(s, Instruction::with2(Code::Or_rm32_r32, Register::EAX, Register::ECX).unwrap());
    push(s, Instruction::with2(Code::Mov_rm32_r32, w(D_OFF + 12), Register::EAX).unwrap());
...
fn emit_mac_add(s: &mut Seq) {
    push(s, Instruction::with2(Code::Xor_r32_rm32, Register::EDX, Register::EDX).unwrap());
    for i in 0..4 {
        // sum = t_i + pad_i + carry  (all < 2^32, sum < 2^34) — 64-bit add so the
        // upper-32 carry is preserved for `sum >> 32`.
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::EAX, w(D_OFF + (i as i32) * 4)).unwrap());
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w(PAD_OFF + (i as i32) * 4)).unwrap());
        push(s, Instruction::with2(Code::Add_rm64_r64, Register::RAX, Register::RCX).unwrap());
        push(s, Instruction::with2(Code::Add_rm64_r64, Register::RAX, Register::RDX).unwrap());
        push(s, Instruction::with2(Code::Mov_rm32_r32, w(MAC_OFF + (i as i32) * 4), Register::EAX).unwrap());
    ...
    push(s, Instruction::with2(Code::Xor_r32_rm32, Register::EAX, Register::EAX).unwrap());
    for i in 0..4 {
        push(s, Instruction::with2(Code::Mov_r32_rm32, Register::ECX, w_disp(Register::R15, (i as i32) * 4)).unwrap());
        push(s, Instruction::with2(Code::Cmp_r32_rm32, Register::ECX, w(MAC_OFF + (i as i32) * 4)).unwrap());
    ...
    lab(s, "mac_fail");
    push(s, Instruction::with2(Code::Mov_r32_imm32, Register::EAX, 1).unwrap());
    lab(s, "mac_done");
}
...
mod tests {
    ...
    fn run_verify(blob: &[u8], region: &[u8], key: &[u8; 32], tag: &[u8; 16]) -> u64 {
        ...
        assert!(blob.len() < 0x10000, "poly1305 blob too large: {}B", blob.len());
    ...
    fn key() -> [u8; 32] {
        (0u8..32).map(|i| i.wrapping_mul(11).wrapping_add(3)).collect::<Vec<_>>().try_into().unwrap()
    }
    ...
    fn poly1305_native_blob_matches_reference_aead() {
        ...
        assert!(blob.len() > 100, "poly1305 native blob too small: {}", blob.len());
        let k = key();
        for len in [0usize, 1, 15, 16, 17, 31, 32, 64, 65, 100, 300, 4096] {
            ...
            assert_eq!(res, 0, "native verify must MATCH reference AEAD tag (len={len})");
        }
    }
